...
cvar = c("pr")
path.res      <- "/glade/campaign/mmm/c3we/ESTCP/CMIP6_downscaled_statistical/AK_10km/OBS_DAYMET/"
...
for (iyr in 1:length(yr)){
  ...
  file_path <- paste0(path.res, cvar,"/bc_pr_day_historical_",yr[iyr],"0101-",yr[iyr],"1231_obs.daymet.nc")
